...
const Project = () => {
	const data = useStaticQuery(graphql`
		query {
			sketch: file(relativePath: { eq: "mobius-strip-club.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 700) {
	...
	return (
		<Page>
			...
			<p>
				...
				space, it lights up revealing a second climbable Möbius strip and
			...
			<p>
				...
				loop are lined with moving LEDs that visit both sides of the Möbius
				strip on their infinite journey. There is a sound system built into the
				outer Möbius loop that comes to life when participants interact with the
				art. Contained within the ring are eight foot high, steel monkey bars in
				the shape of a Möbius infinity sign. Mounted from the monkey bars in the
				center of the ring is a dancing pole. The monkey bars and pole are lit
